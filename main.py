...
label_input_data_name = ttk.Label(main_frame, text="Name:", foreground="black")
label_input_data_description = ttk.Label(main_frame, text="Description:", foreground="black")
label_input_data_units = ttk.Label(main_frame, text="Units:", foreground="black")
label_output_data = ttk.Label(main_frame, text="Output Data:", foreground="black")
label_output_data_name = ttk.Label(main_frame, text="Name:", foreground="black")
label_output_data_description = ttk.Label(main_frame, text="Description:", foreground="black")
label_output_data_units = ttk.Label(main_frame, text="Units:", foreground="black")

label_computational_reqs = ttk.Label(main_frame, text="Computational Requirements:", foreground="black")
label_calibration_vars = ttk.Label(main_frame, text="Calibration Varables", foreground="black")
label_calibration_vars_name = ttk.Label(main_frame, text="Name:", foreground="black")
label_calibration_vars_description = ttk.Label(main_frame, text="Description:", foreground="black")
label_calibration_vars_units = ttk.Label(main_frame, text="Units:", foreground="black")
...
entry_computational_reqs = ttk.Entry(main_frame)


dims_var = tk.StringVar()
dims_combobox = ttk.Combobox(main_frame, textvariable=dims_var, values=["0D", "1D", "2D", "3D"], state="readonly")
...
def add_input():
   global input_count
   input_entries.append((ttk.Entry(main_frame),ttk.Entry(main_frame),ttk.Entry(main_frame)))
...
ttk.Button(main_frame, text='Add', command=add_input).grid(row=1, column=3, padx=10, pady=5)
...
def add_output():
   global output_count
   output_entries.append((ttk.Entry(main_frame),ttk.Entry(main_frame),ttk.Entry(main_frame)))
...
ttk.Button(main_frame, text='Add', command=add_output).grid(row=1, column=7, padx=10, pady=5)
...
def add_calibration_var():
   ...
   calibration_vars_entries.append((ttk.Entry(main_frame),ttk.Entry(main_frame),ttk.Entry(main_frame)))
...
ttk.Button(main_frame, text='Add', command=add_calibration_var).grid(row=7, column=1, padx=10, pady=5, sticky="w")
